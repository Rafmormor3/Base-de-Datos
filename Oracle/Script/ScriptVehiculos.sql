...
(
	...
	CONSTRAINT CHK1_PRECIO_POR_DIA CHECK (PRECIO_POR_DIA > 0),
	CONSTRAINT CHK2_FECHA_COMPRA CHECK (EXTRACT (YEAR FROM FECHA_COMPRA)>2001)
);
...
ALTER TABLE VEHICULOS ADD TOTAL_KM NUMBER(10);
